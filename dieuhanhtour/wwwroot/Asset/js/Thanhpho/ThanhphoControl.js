var ThanhphoControl = {
    ...
    registerEvent: function () {
        $(document).ready(function () {           
            ...
            $('#tbTinh').off('click').on('click', 'tbody tr', function (event) {
        ...
        $(function () {          
            if ($.fn.dataTable.isDataTable('#tbTinh')) {
                table = $('#tbTinh').DataTable();               
            }
            else {
                table = $('#tbTinh').DataTable({
                    'paging': false,
